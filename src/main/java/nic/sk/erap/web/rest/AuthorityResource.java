...
/**
 * REST controller for managing {@link nic.sk.erap.domain.Authority}.
 */
@RestController
...
public class AuthorityResource {
    ...
    @PreAuthorize("hasAnyAuthority( 'ROLE_SITE_ADMIN')")
    public List<Authority> getAllAuthoritiesForNewUserAtSiteAdmin() {
        LOG.debug("REST request to get all Authorities");
        List<String> allowedAuthorities = new ArrayList<>();
        allowedAuthorities.add(AuthoritiesConstants.SITE_ADMIN);
        return authorityRepository.findAllByNameIn(allowedAuthorities);
    }
